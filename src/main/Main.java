                            ...
                            while (!retour) {
                                ...
                                switch (choix) {
                                    ...
                                    case 3:
                                        ...
                                        Projet newProjet = new Projet(1, nom_projet, sujet, techno, new Date(System.currentTimeMillis()), new Date(2024, 12, 28), true);
...
//                                                   System.out.println("lister les   messages lier au forum "+tab.get(i));
                                                    break;
                                                case 6:
                                                    System.out.println("lister les membres du projet");
                    ...
                    case 3:
                        ...
                        List<Projet> tabPP = Requetes.allProjectPublic(NOMDB);
                        for (int i = 0; i < tabPP.size(); i++) {
                            System.out.println(tabPP.get(i));
                            Requetes.afficherMembresDuProjet(NOMDB,tabPP.get(i).getId());
                        }
                        break;
